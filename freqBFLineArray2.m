...
% A is going to replace my creation of the observation signals above, and
% it's going to do it in the frequency domain. 


% Initialize W
W = ones(N,numWin); % 512 bins x 649 time indexes, no need for F
